...
const IdentityGuide: React.FC<IdentityGuideProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-zinc-900 text-white border border-zinc-700 max-w-3xl h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-amber-400 text-center text-2xl mb-4">
            {language === 'english' ? 'Managing Your Spiritual Identity' : 'आपकी आध्यात्मिक पहचान का प्रबंधन'}
          </DialogTitle>
        </DialogHeader>
          ...
          <Tabs value={language} onValueChange={setLanguage} className="w-full">
            ...
            <TabsContent value="english" className="space-y-6">
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">What is your Identity?</h3>
                <p className="text-gray-300">
                  Your spiritual identity in our app consists of your chosen name, date of birth, 
                  and spiritual symbol. This identity helps personalize your chanting experience.
                </p>
              </section>
              
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">Your Unique ID</h3>
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">How to Recover Your ID</h3>
                ...
                <ol className="list-decimal pl-6 space-y-1 text-gray-300">
                  <li>Click on "Forgot ID" on the login screen</li>
                  <li>Enter your name and date of birth</li>
                  <li>The system will show possible IDs that match your information</li>
                  <li>Select your ID to access your account</li>
                </ol>
              </section>
              
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">How Your Identity is Stored</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">Accessing Your Identity on Different Devices</h3>
                
                <h4 className="font-medium text-white mt-3 mb-1">On Desktop Browsers:</h4>
                <ol className="list-decimal pl-6 space-y-1 text-gray-300">
                  <li>Simply enter your ID on the login screen</li>
                  <li>Alternatively, use the "Forgot ID" option with your name and DOB</li>
                  <li>Your profile will be restored with all your chanting history</li>
                </ol>
                
                <h4 className="font-medium text-white mt-3 mb-1">On Mobile Devices:</h4>
                <ol className="list-decimal pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">Security Considerations</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">Troubleshooting</h3>
                ...
                <p className="text-gray-300 mt-3">Need more help? Contact us through the feedback form.</p>
              </section>
            </TabsContent>
            
            <TabsContent value="hindi" className="space-y-6">
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">आपकी पहचान क्या है?</h3>
                <p className="text-gray-300">
                  हमारे ऐप में आपकी आध्यात्मिक पहचान में आपका चुना हुआ नाम, जन्म तिथि और
                  आध्यात्मिक प्रतीक शामिल है। यह पहचान आपके जप अनुभव को व्यक्तिगत बनाने में मदद करती है।
                </p>
              </section>
              
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">आपकी अनूठी आईडी</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">अपनी आईडी को पुनः प्राप्त कैसे करें</h3>
                <p className="text-gray-300 mb-2">यदि आप अपनी पूरी आईडी भूल जाते हैं लेकिन अपनी जन्म तिथि याद है:</p>
                <ol className="list-decimal pl-6 space-y-1 text-gray-300">
                  <li>लॉगिन स्क्रीन पर "आईडी भूल गए" पर क्लिक करें</li>
                  <li>अपना नाम और जन्म तिथि दर्ज करें</li>
                  <li>सिस्टम आपकी जानकारी से मेल खाने वाली संभावित आईडी दिखाएगा</li>
                  <li>अपने खाते तक पहुंचने के लिए अपनी आईडी का चयन करें</li>
                </ol>
              </section>
              
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">आपकी पहचान कैसे संग्रहीत की जाती है</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">विभिन्न डिवाइसों पर अपनी पहचान तक पहुंचना</h3>
                
                <h4 className="font-medium text-white mt-3 mb-1">डेस्कटॉप ब्राउज़र पर:</h4>
                <ol className="list-decimal pl-6 space-y-1 text-gray-300">
                  <li>लॉगिन स्क्रीन पर अपनी आईडी दर्ज करें</li>
                  <li>वैकल्पिक रूप से, अपने नाम और जन्म तिथि के साथ "आईडी भूल गए" विकल्प का उपयोग करें</li>
                  <li>आपकी प्रोफ़ाइल आपके सभी जप इतिहास के साथ पुनर्स्थापित की जाएगी</li>
                </ol>
                
                <h4 className="font-medium text-white mt-3 mb-1">मोबाइल डिवाइस पर:</h4>
                <ol className="list-decimal pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">सुरक्षा विचार</h3>
                <ul className="list-disc pl-6 space-y-1 text-gray-300">
              ...
              <section className="bg-zinc-800 p-4 rounded-lg">
                <h3 className="text-xl font-medium text-amber-400 mb-2">समस्या निवारण</h3>
                ...
                <p className="text-gray-300 mt-3">अधिक सहायता चाहिए? प्रतिक्रिया फॉर्म के माध्यम से हमसे संपर्क करें।</p>
              </section>
            </TabsContent>
          </Tabs>
        </div>
        ...
        <div className="flex justify-center">
          <Button onClick={onClose} className="bg-amber-500 hover:bg-amber-600 text-black px-8">
            Close
          </Button>
        </div>
      </DialogContent>
